    ...
    <div className="w-full max-w-2xl mx-auto my-2"> 
      <div className="flex justify-between items-center mb-4">
        <div className="flex justify-between items-center font-bold">
            <div className="flex items-center text-white bg-transparent rounded-lg px-4">
      ...
      <div class="p-2 rounded-lg shadow-md ml-4">
        <p class="text-white text-base leading-6">{content}</p>
    </div>
    </div>
  );
}
